 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Joel Ye");
		  toPrint += p1.toString("jye72");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jihwan Kim");
		  toPrint += p2.toString("JKimG1, 903036024");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Shiva Devarajan");
		  toPrint += p3.toString("sdevarajan3");
